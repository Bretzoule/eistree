    ...
    <div id="centerPanel">
        ...
        <div id="bloc_Login">
            <form accept-charset="UTF-8" action="/login/verifLogin.php" method="post">
                <input name="login" type="text" pattern="[^\s\x3B]+" value="" placeholder="Email" oninvalid='setCustomValidity("Champ obligatoire - Merci de ne pas utiliser \"espace\" et ; ")' oninput="setCustomValidity('')" required /><br>
